...
def main():
    parser = argparse.ArgumentParser(
        description="Show dns records (i.e.: NS, MX, A, AAAA) of a domain."
    )
    parser.add_argument(
        "-v",
        "--version",
    ...
    parser.add_argument(
        metavar="TYPE",
        dest="query_type",
        help="Type of record (i.e.: NS, MX, A, AAAA). Pass ALL for query all records.",
    )
    parser.add_argument(
        metavar="DOMAIN", dest="domain", help="The domain to run query."
    )
