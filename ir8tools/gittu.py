...
def main():
    parser = argparse.ArgumentParser(
        description="One command commit and push to current git branch.", add_help=False
    )
    parser.add_argument(
        type=str,
        dest="msg",
        nargs="*",
        metavar="MESSAGE",
        help="Add commit message. Current date and time will be added as message if this parameter is missing.",
    )
    parser.add_argument(
        "-v",
        "--version",
